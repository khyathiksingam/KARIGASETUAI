    ...
    >
      <div>
        ...
        <div
          ...
          className="relative aspect-square w-full rounded-2xl overflow-hidden bg-heritage-sand/30 transition-transform duration-300 shadow-sm"
        >
          <img
          ...
          <div className="absolute top-2.5 left-2.5 flex items-center space-x-1.5">
            ...
            {product.is_dimensions_estimated && (
              <span className="bg-emerald-800/80 backdrop-blur-md text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-md flex items-center">
                AI Specs
              </span>
            )}
          </div>
      ...
      <div className="mt-4 pt-2.5 border-t border-heritage-sand/60 flex items-center justify-between">
        <div>
          ...
          <div className="flex items-baseline space-x-1.5">
            ...
            {product.market_price_max > product.price && (
              <span className="text-[11px] text-heritage-charcoal/50 line-through">
        ...
        <div className="flex items-center space-x-1.5">
          <Link
            ...
            className="px-2.5 py-1.5 rounded-xl text-xs font-bold text-heritage-brown bg-heritage-sand/60 hover:bg-heritage-sand transition"
          >
            Details
          </Link>
          <button
            onClick={handleAddToCart}
            className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center space-x-1 transition-all shadow-sm ${
              addedNotice
