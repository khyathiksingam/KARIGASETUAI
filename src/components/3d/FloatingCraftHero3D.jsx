...
export const FloatingCraftHero3D = () => {
    ...
    const [activeCraft, setActiveCraft] = useState(FLOATING_CRAFTS[0]);
    ...
    return (<div onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} className="relative w-full h-[520px] lg:h-[600px] flex items-center justify-center perspective-1000 select-none overflow-hidden">
      ...
      <div style={{
        ...
        <div style={{ transform: 'translateZ(120px)' }} className="relative z-30 w-72 sm:w-80 bg-white/95 rounded-3xl p-4 shadow-3d-lg border-2 border-heritage-gold/50 backdrop-blur-xl transition-all duration-300">
          <div className="relative h-64 rounded-2xl overflow-hidden shadow-inner group">
            <img src={activeCraft.image} alt={activeCraft.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"/>
        ...
        <div onClick={() => setActiveCraft(FLOATING_CRAFTS[0])} style={{ transform: 'translate3d(-140px, -110px, 50px)' }} className="absolute z-20 cursor-pointer group hover:scale-110 transition-all duration-300">
          <div className="w-32 sm:w-36 bg-white/90 backdrop-blur-md p-2 rounded-2xl shadow-3d border border-heritage-terracotta/30 rotate-[-6deg] hover:rotate-0">
            <div className="h-24 rounded-xl overflow-hidden">
              <img src={FLOATING_CRAFTS[0].image} alt="Wood Craft" className="w-full h-full object-cover"/>
            </div>
        ...
        {/* 2. Pottery (Top Right) */}
        <div onClick={() => setActiveCraft(FLOATING_CRAFTS[1])} style={{ transform: 'translate3d(145px, -120px, 80px)' }} className="absolute z-20 cursor-pointer group hover:scale-110 transition-all duration-300">
          <div className="w-32 sm:w-36 bg-white/90 backdrop-blur-md p-2 rounded-2xl shadow-3d border border-heritage-gold/40 rotate-[6deg] hover:rotate-0">
            <div className="h-24 rounded-xl overflow-hidden">
              <img src={FLOATING_CRAFTS[1].image} alt="Pottery" className="w-full h-full object-cover"/>
            </div>
            <p className="text-[11px] font-bold text-heritage-brown mt-1 truncate">
              Blue Pottery
            </p>
        ...
        <div onClick={() => setActiveCraft(FLOATING_CRAFTS[2])} style={{ transform: 'translate3d(-150px, 120px, 60px)' }} className="absolute z-20 cursor-pointer group hover:scale-110 transition-all duration-300">
          <div className="w-32 sm:w-36 bg-white/90 backdrop-blur-md p-2 rounded-2xl shadow-3d border border-heritage-green/40 rotate-[-4deg] hover:rotate-0">
            <div className="h-24 rounded-xl overflow-hidden">
              <img src={FLOATING_CRAFTS[2].image} alt="Handloom" className="w-full h-full object-cover"/>
            </div>
            <p className="text-[11px] font-bold text-heritage-brown mt-1 truncate">
              Handloom Saree
            </p>
        ...
        <div onClick={() => setActiveCraft(FLOATING_CRAFTS[3])} style={{ transform: 'translate3d(140px, 110px, 70px)' }} className="absolute z-20 cursor-pointer group hover:scale-110 transition-all duration-300">
          <div className="w-32 sm:w-36 bg-white/90 backdrop-blur-md p-2 rounded-2xl shadow-3d border border-amber-600/30 rotate-[5deg] hover:rotate-0">
            <div className="h-24 rounded-xl overflow-hidden">
              <img src={FLOATING_CRAFTS[3].image} alt="Bamboo Craft" className="w-full h-full object-cover"/>
            </div>
            <p className="text-[11px] font-bold text-heritage-brown mt-1 truncate">
              Bamboo & Cane
            </p>
        ...
        <div onClick={() => setActiveCraft(FLOATING_CRAFTS[4])} style={{ transform: 'translate3d(0px, -180px, 110px)' }} className="absolute z-10 cursor-pointer group hover:scale-110 transition-all duration-300 hidden sm:block">
          <div className="w-28 bg-heritage-brown text-white p-2 rounded-2xl shadow-3d border border-heritage-gold/60">
            <div className="h-16 rounded-lg overflow-hidden">
              <img src={FLOATING_CRAFTS[4].image} alt="Metal Craft" className="w-full h-full object-cover"/>
            </div>
