...
export const Avatar = ({ src, name = 'Artisan', size = 'md', className = '', role, showBadge = false, }) => {
    ...
    const renderFallbackSvg = () => {
        if (isRavi) {
            ...
            return (<svg viewBox="0 0 100 100" className="w-full h-full object-cover" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Background */}
          ...
          <path d="M30 35 C30 20, 70 20, 70 35 C70 26, 62 16, 50 16 C38 16, 30 26, 30 35 Z" fill="#3B1E08"/>
          {/* Facial Features */}
          ...
          <path d="M38 50 Q45 47 50 51 Q55 47 62 50 Q56 55 50 52 Q44 55 38 50 Z" fill="#2C1810"/>
          {/* Warm smile */}
        ...
        if (isAnanya) {
          ...
          {/* Hair */}
          <path d="M28 42 C26 22, 74 22, 72 42 C72 26, 64 16, 50 16 C36 16, 28 26, 28 42 Z" fill="#1A110B"/>
          {/* Bindi */}
