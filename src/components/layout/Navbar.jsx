...
import { Sparkles, ShoppingBag, Heart, Menu, X, LogOut, Layers, Scan, LayoutDashboard, Award } from 'lucide-react';
    ...
    return (<header className="sticky top-0 z-50 bg-heritage-ivory/90 backdrop-blur-md border-b border-heritage-terracotta/15 transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Mobile menu toggle */}
          <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden p-2 text-heritage-brown hover:text-heritage-terracotta">
