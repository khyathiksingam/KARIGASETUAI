...
import { Sparkles, Search, ShoppingBag, ArrowRight, Star } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl p-6 border border-heritage-gold/40 shadow-3d space-y-4">
            ...
            <div className="space-y-3">
              {DEMO_SELLERS.slice(0, 3).map((seller) => (<Link key={seller.id} to={`/artisan/${seller.username}`} className="p-3 rounded-2xl border border-heritage-sand hover:bg-heritage-sand/30 transition flex items-center justify-between group">
                  <div className="flex items-center space-x-3">
                    <Avatar src={seller.profile_image} name={seller.full_name} role="seller" size="md" className="border border-heritage-gold shadow-sm shrink-0"/>
                    <div>
