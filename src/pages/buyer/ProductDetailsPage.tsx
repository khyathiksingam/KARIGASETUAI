...
export const ProductDetailsPage: React.FC = () => {
  ...
  const moreFromArtisan = products.filter(
    (p) => p.seller_id === product.seller_id && p.id !== product.id
  );
    ...
    <div className="min-h-screen bg-heritage-ivory py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-white border border-heritage-terracotta/20 shadow-3d flex items-baseline justify-between">
              <div>
                ...
                <div className="flex items-baseline space-x-2 mt-0.5">
                  ...
                  {product.market_price_max > product.price && (
                    <span className="text-sm text-heritage-charcoal/50 line-through">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div>
                  <span className="text-[10px] text-heritage-charcoal/50 block flex items-center">
                    Dimensions 
                    {product.is_dimensions_estimated && (
                      <span className="ml-1 text-[9px] font-semibold text-emerald-700">(AI Estimated)</span>
                    )}
                  </span>
            ...
            <div className="bg-gradient-to-r from-heritage-sand/60 to-white rounded-2xl p-4 border border-heritage-gold/50 shadow-sm flex items-center justify-between">
              ...
              <div className="text-right flex flex-col items-end">
                ...
                <button
                  ...
                  className="mt-2 text-xs font-bold text-heritage-terracotta hover:underline flex items-center"
                >
            ...
            <div className="space-y-3 pt-2">
              {addedNotice && (
                <div className="p-3 bg-emerald-100 border border-emerald-300 rounded-xl text-xs font-bold text-emerald-900 flex items-center space-x-2">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <button
                  ...
                  className="w-full sm:flex-1 py-3.5 rounded-2xl bg-heritage-sand hover:bg-heritage-sand/80 text-heritage-brown font-bold text-xs shadow-sm transition flex items-center justify-center space-x-2"
                >
                ...
                <button
                  ...
                  className="w-full sm:flex-1 py-3.5 rounded-2xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-xs shadow-3d hover:shadow-3d-lg transition flex items-center justify-center space-x-2"
                >
        ...
        {moreFromArtisan.length > 0 && (
          <div className="pt-10 border-t border-heritage-sand space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {moreFromArtisan.slice(0, 4).map((p) => (
              ...
              {inquirySent ? (
                ...
                <form onSubmit={handleSendInquiry} className="space-y-4">
                  <textarea
                    ...
                    placeholder="Namaste, I am interested in this craft. Could you clarify..."
