  ...
  return (
    <div className="min-h-screen bg-heritage-ivory py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-heritage-sand pb-4">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              placeholder="Search craft, artisan, material, city..."
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-heritage-sand bg-white text-xs font-medium focus:border-heritage-terracotta outline-none shadow-sm"
            />
            {search && (
              <button
                type="button"
                onClick={() => setSearch('')}
                className="absolute right-3 top-3 text-xs text-heritage-charcoal/40 hover:text-heritage-brown"
              >
        ...
        <div className="flex items-center space-x-2 overflow-x-auto pb-2 scrollbar-none">
          {CRAFT_CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-full text-xs font-bold whitespace-nowrap transition flex items-center space-x-1.5 shadow-sm ${
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white p-3 rounded-2xl border border-heritage-sand shadow-sm">
          <div className="flex items-center space-x-3 w-full sm:w-auto">
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-heritage-sand/60 hover:bg-heritage-sand text-xs font-bold text-heritage-brown flex items-center space-x-1.5 transition"
            >
              <SlidersHorizontal className="w-3.5 h-3.5 text-heritage-terracotta" />
              <span>Filter Crafts</span>
            </button>
            {(selectedCategory !== 'all' || selectedMaterial !== 'all' || selectedState !== 'all' || selectedRating > 0 || maxPrice < 20000 || search) && (
              <button
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-xl border border-heritage-sand bg-heritage-ivory/40 text-xs font-bold text-heritage-brown focus:border-heritage-terracotta outline-none"
            >
        ...
        {filterDrawerOpen && (
          <div className="bg-white rounded-3xl p-6 border border-heritage-terracotta/20 shadow-3d space-y-6">
            <div className="flex items-center justify-between border-b border-heritage-sand pb-3">
              ...
              <button
                ...
                className="text-xs text-heritage-charcoal/60 hover:text-heritage-brown"
              >
                Close Filters
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 rounded-xl border border-heritage-sand bg-heritage-ivory/30 text-xs font-medium focus:border-heritage-terracotta outline-none"
                >
                  {materials.map((m) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full accent-heritage-terracotta"
                />
              </div>
            </div>
          </div>
