  ...
  return (
    <div className="min-h-screen bg-heritage-ivory py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {photoUpdatedToast && (
          <div className="p-3 bg-emerald-700 text-white rounded-2xl flex items-center justify-between text-xs font-bold shadow-lg animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-heritage-brown via-heritage-brown-dark to-heritage-terracotta text-white rounded-3xl p-6 sm:p-8 shadow-3d-lg border-2 border-heritage-gold/40 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              ...
              className="px-5 py-3 rounded-2xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-xs shadow-md flex items-center space-x-2 transition hover:scale-102"
            >
            ...
            <Link
              ...
              className="px-4 py-3 rounded-2xl bg-white/10 hover:bg-white/20 text-heritage-gold-light border border-heritage-gold/40 font-bold text-xs transition"
            >
        ...
        <div className="bg-white rounded-3xl p-6 border border-heritage-terracotta/20 shadow-3d">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            <Link
              to="/seller/ai-analyzer"
              className="p-4 rounded-2xl bg-heritage-sand/40 hover:bg-heritage-sand hover:border-heritage-terracotta border border-heritage-sand transition flex flex-col items-center text-center group"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 bg-white rounded-3xl p-6 border border-heritage-terracotta/20 shadow-3d">
            ...
            {sellerOrders.length === 0 ? (
              <div className="text-center py-12 bg-heritage-ivory/50 rounded-2xl border border-dashed border-heritage-sand">
              ...
              <div className="space-y-3">
                {sellerOrders.slice(0, 3).map((ord) => (
                  <div
                    key={ord.id}
                    className="p-4 rounded-2xl border border-heritage-sand bg-heritage-ivory/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                  >
                    <div className="flex items-center space-x-3">
                      <img
                        src={ord.items[0]?.product_image}
                        alt="Product"
                        className="w-14 h-14 rounded-xl object-cover border border-heritage-sand shadow-sm"
                      />
                      <div>
                        <div className="flex items-center space-x-2">
                    ...
                    <div className="text-right flex sm:flex-col items-center sm:items-end justify-between">
                      ...
                      <Link
                        to="/seller/orders"
                        className="text-xs font-bold text-heritage-brown bg-heritage-sand/60 px-3 py-1.5 rounded-lg hover:bg-heritage-sand transition mt-1"
                      >
                        Manage Status
                      </Link>
                    </div>
          ...
          <div className="lg:col-span-4 bg-gradient-to-b from-white to-heritage-sand/30 rounded-3xl p-6 border border-heritage-gold/40 shadow-3d flex flex-col items-center justify-between">
            ...
            <div className="my-6">
              <CreditBadgeRadial
                credits={currentUser?.credits || 1250}
                badge={currentUser?.badge || 'Trusted Artisan'}
                size="lg"
              />
            </div>
            ...
            <Link
              to="/seller/credits"
              className="mt-4 text-xs font-bold text-heritage-terracotta hover:underline"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 border border-heritage-terracotta/20 shadow-3d space-y-4">
            <div className="flex items-center justify-between border-b border-heritage-sand pb-3">
              ...
              <Link
                to="/seller/profile"
                className="text-[11px] font-bold text-heritage-terracotta hover:underline"
              >
                + New Voucher
              </Link>
            </div>
            ...
            <div className="space-y-2 max-h-36 overflow-y-auto pr-1">
              {coupons.slice(0, 3).map((c) => (
                <div
                  key={c.id}
                  className="p-2.5 rounded-xl bg-heritage-ivory/40 border border-heritage-sand flex items-center justify-between text-xs"
                >
                  <div className="flex items-center space-x-2">
            ...
            <div className="pt-1 flex items-center justify-between text-xs">
              ...
              <Link
                to="/seller/profile"
                className="font-bold text-heritage-terracotta hover:underline flex items-center"
              >
