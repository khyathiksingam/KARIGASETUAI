...
export const SignupPage: React.FC = () => {
  ...
  const handleSendSignupOtp = (channel: 'mobile' | 'email') => {
    setOtpError('');
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-heritage-terracotta/20 shadow-3d">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                  <img
                    ...
                    alt="Profile Avatar"
                    className="w-20 h-20 rounded-full object-cover border-2 border-heritage-gold shadow-md group-hover:opacity-80 transition"
                  />
                ...
                <div>
                  ...
                  <button
                    ...
                    className="mt-2 px-3 py-1 bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white rounded-lg text-xs font-bold shadow-xs transition"
                  >
                    Upload Custom Photo
                  </button>
                </div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-heritage-sand/40 to-heritage-ivory border border-heritage-terracotta/30 space-y-3">
              ...
              {isOtpVerified ? (
                ...
                <div className="space-y-2.5">
                  ...
                  {otpSent && (
                    <div className="pt-2 border-t border-heritage-sand/60 space-y-2 animate-fade-in">
                      <div className="flex items-center justify-between">
                        ...
                        {generatedOtp && (
                          <button
                            ...
                            className="text-[11px] text-heritage-terracotta font-bold hover:underline flex items-center space-x-0.5"
                          >
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="flex-1 text-center font-mono font-bold tracking-widest text-base py-1.5 px-3 rounded-xl border border-heritage-sand bg-white text-heritage-brown focus:border-heritage-terracotta outline-none"
                        />
                        <button
                          type="button"
                          onClick={handleVerifySignupOtp}
                          className="py-2 px-4 rounded-xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-xs shadow-xs transition"
                        >
                          Verify OTP
                        </button>
                      </div>
                      ...
                      <div className="flex items-center justify-between text-[10px] text-heritage-charcoal/60 pt-0.5">
                        ...
                        <button
                          ...
                          onClick={() => handleSendSignupOtp(otpChannel)}
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-2xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-sm shadow-3d hover:scale-101 transition flex items-center justify-center space-x-2"
            >
