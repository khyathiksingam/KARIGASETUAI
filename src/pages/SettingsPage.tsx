  ...
  return (
    <div className="min-h-screen bg-heritage-ivory py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {resetSuccess && (
          <div className="p-4 bg-emerald-100 border border-emerald-300 rounded-2xl text-emerald-900 text-xs font-bold flex items-center space-x-2">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border-2 border-heritage-terracotta/30 shadow-3d space-y-4">
          <div className="flex items-start justify-between">
            ...
            <button
              type="button"
              onClick={handleReset}
              className="px-5 py-3 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs shadow-md transition flex items-center space-x-2"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div className="p-4 rounded-2xl bg-heritage-ivory/60 border border-heritage-sand space-y-2">
              ...
              <button
                ...
                className="w-full py-2 bg-heritage-terracotta/15 hover:bg-heritage-terracotta hover:text-white text-heritage-terracotta font-bold rounded-xl transition text-[11px]"
              >
            ...
            <div className="p-4 rounded-2xl bg-heritage-ivory/60 border border-heritage-sand space-y-2">
              ...
              <button
                ...
                className="w-full py-2 bg-heritage-brown/15 hover:bg-heritage-brown hover:text-white text-heritage-brown font-bold rounded-xl transition text-[11px]"
              >
