...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-heritage-ivory bg-heritage-pattern">
      {/* 3D HERO SECTION */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                <Link
                  to="/marketplace"
                  className="w-full sm:w-auto px-7 py-3.5 rounded-2xl bg-gradient-to-r from-heritage-terracotta to-heritage-terracotta-dark text-white font-bold text-sm shadow-3d hover:shadow-3d-lg hover:-translate-y-0.5 transition-all flex items-center justify-center space-x-2"
                >
                ...
                <Link
                  ...
                  className="w-full sm:w-auto px-7 py-3.5 rounded-2xl bg-heritage-brown text-heritage-gold-light border border-heritage-gold/50 font-bold text-sm shadow-3d hover:shadow-3d-lg hover:-translate-y-0.5 transition-all flex items-center justify-center space-x-2 group"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-heritage-ivory to-heritage-sand/60 p-8 rounded-3xl border-2 border-heritage-terracotta/20 shadow-3d">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-3.5 bg-white/80 p-3.5 rounded-2xl border border-heritage-sand shadow-sm">
              ...
              <div className="mt-6 text-center">
                <Link
                  to="/seller/ai-analyzer"
                  className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-xs shadow-md transition"
                >
            ...
            <div className="bg-gradient-to-br from-heritage-ivory to-heritage-sand/60 p-8 rounded-3xl border-2 border-heritage-gold/40 shadow-3d">
              ...
              <div className="mt-6 text-center">
                <Link
                  to="/marketplace"
                  className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl bg-heritage-brown hover:bg-heritage-brown-dark text-heritage-gold-light font-bold text-xs shadow-md transition"
                >
      ...
      <section className="py-16 bg-white border-t border-heritage-terracotta/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-10">
            ...
            <Link
              to="/marketplace"
              className="mt-3 sm:mt-0 text-sm font-bold text-heritage-terracotta hover:text-heritage-terracotta-dark flex items-center"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {DEMO_SELLERS.slice(0, 3).map((seller) => (
              <div
                key={seller.id}
                className="card-3d bg-white rounded-3xl p-6 border border-heritage-terracotta/20 shadow-3d flex flex-col justify-between"
              >
                <div>
                ...
                <div className="mt-5 pt-4 border-t border-heritage-sand">
                  <Link
                    ...
                    className="w-full block text-center py-2 rounded-xl text-xs font-bold text-heritage-brown bg-heritage-sand/60 hover:bg-heritage-sand transition"
                  >
      ...
      <section className="py-20 bg-gradient-to-r from-heritage-brown via-heritage-brown-dark to-heritage-brown text-heritage-sand border-t-4 border-heritage-gold relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              to="/seller/ai-analyzer"
              className="px-8 py-3.5 rounded-2xl bg-heritage-terracotta hover:bg-heritage-terracotta-dark text-white font-bold text-sm shadow-3d-lg transition-transform hover:scale-105"
            >
              Analyze Your First Craft Now
            </Link>
            <Link
              to="/select-role"
              className="px-8 py-3.5 rounded-2xl bg-white/10 hover:bg-white/20 text-heritage-gold-light border border-heritage-gold/40 font-bold text-sm transition"
            >
